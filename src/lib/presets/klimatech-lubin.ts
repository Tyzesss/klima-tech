...
export const klimatechLubinPreset: SitePreset = {
  ...
  logoUrl: "/logo.png",
  heroImage: "/gallery/klimatech-hero.webp",
  ...
  ogImage: "/gallery/klimatech-hero.webp",
  googleRating: 5.0,
  ...
  gallery: [
    {
      ...
      alt: "Montaż jednostki wewnętrznej Rotenso — realizacja KLIMA-TECH Lubin",
      caption: "Jednostka wewnętrzna Rotenso",
    },
    {
      image: "/gallery/klimatech-2.webp",
      alt: "Montaż jednostki zewnętrznej na elewacji — realizacja KLIMA-TECH",
      caption: "Jednostka zewnętrzna",
    },
    {
      image: "/gallery/klimatech-3.webp",
      alt: "Montaż klimatyzacji AUX na balkonie — realizacja KLIMA-TECH",
      caption: "Montaż AUX na balkonie",
    },
    {
      image: "/gallery/klimatech-4.webp",
      alt: "Jednostka wewnętrzna AUX — montaż KLIMA-TECH Lubin",
      caption: "Jednostka wewnętrzna AUX",
    },
    {
      image: "/gallery/klimatech-5.webp",
      alt: "Klimatyzacja w salonie — instalacja nad telewizorem",
      caption: "Klimatyzacja w salonie",
    },
    {
      image: "/gallery/klimatech-6.webp",
      alt: "Klimatyzacja biurowa — jednostka ścienna w open space",
